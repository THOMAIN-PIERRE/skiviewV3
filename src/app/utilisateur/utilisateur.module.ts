...
@NgModule({
  declarations: [GestionCompteComponent, InscriptionComponent, ConnexionComponent, ServicesComponent, CreationcompteComponent, AccueilutilisateurComponent, ChoixstationComponent],
  imports: [
